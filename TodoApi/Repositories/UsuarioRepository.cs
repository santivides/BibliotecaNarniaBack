...
namespace TodoApi.Repositories
{
    ...
    public class UsuarioRepository : IUsuarioRepository {
        ...
        public async Task<Usuario?> ObtenerUsuarioPorDocumentoAsync(string numeroDocumento)
        {
        ...
        // public Task<Usuario?> ObtenerUsuarioPorDocumentoAsync(string numeroDocumento)
        // {
        //     throw new NotImplementedException();
        // }

        public Task<Usuario> ObtenerPorNumeroDocumento(string numeroDocumento)
        {
            throw new NotImplementedException();
        }
